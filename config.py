...
EXTERNAL_SOURCE_YU28_DEFAULT_BASE_URL = os.getenv('EXTERNAL_SOURCE_YU28_DEFAULT_BASE_URL', 'https://yu28.top')
EXTERNAL_SOURCE_YU28_CATALOG_PAGES = max(1, int(os.getenv('EXTERNAL_SOURCE_YU28_CATALOG_PAGES', 2)))
